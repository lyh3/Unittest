...
namespace Intel.MsoAuto.C3.Loader.WSPW.Business.Entities
{
    public class AllocatedGasChemTransaction
    {
        ...
        public string UnitCostAmt { get; set; }
        public string ConsumptionValueAmt { get; set; }
        public string FixedCostConsumedQty { get; set; }
        public string ConsumptionRatioPct { get; set; }
        public string UnitOfMeasureCd { get; set; }
    }

    public class AllocatedGasChemTransactionList : List<AllocatedGasChemTransaction>
    {
    }
}
